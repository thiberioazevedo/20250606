...
namespace Thunders.TechTest.ApiService.Migrations
{
    ...
    [Migration("20250612231408_AjusteIndiceVeiculo")]
    partial class AjusteIndiceVeiculo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Thunders.TechTest.ApiService.Models.PedagioUtilizacao", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("PracaId", "DataHoraUtilizacao"), new[] { "ValorPago" });

                    b.HasIndex("PracaId", "VeiculoId")
                        .HasDatabaseName("IX_PedagioUtilizacao_PracaId_VeiculoId");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("PracaId", "VeiculoId"), new[] { "ValorPago" });
            ...
            modelBuilder.Entity("Thunders.TechTest.ApiService.Models.Veiculo", b =>
                {
                    ...
                    b.HasIndex("TipoVeiculo", "Id")
                        .HasDatabaseName("IX_Veiculo_TipoVeiculo_Id");
